...
echo "================================================="
azure servicefabric application upgrade start --application-name fabric:/dh1 --target-application-type-version $BUILD_BUILDNUMBER --rolling-upgrade-mode Monitored
